...
const zh: Record<string, string> = {
  ...
  "distill.mode": "提取模式",
  "distill.mode.agent": "agent 提取（LLM，高质量）",
  "distill.mode.rules": "规则收割（零 token，只取显式「记住…」指令）",
  "chat.stop": "停止当前回复",
...
const en: Record<string, string> = {
  ...
  "distill.mode": "Extraction mode",
  "distill.mode.agent": "Agent extraction (LLM, higher quality)",
  "distill.mode.rules": "Rules harvest (zero tokens — explicit \"remember…\" directives only)",
