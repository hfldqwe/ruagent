...
const zh: Record<string, string> = {
  ...
  "nav.stats": "统计",
    "nav.settings": "设置",
  "settings.title": "设置",
  "settings.subtitle": "平台行为配置——蒸馏策略、运行偏好",
  "nav.inbox": "收件箱",
  ...
  "distill.prompt": "自定义提取提示词",
  "distill.promptPh": "留空使用内置提示词（完整替换；会话转录仍由 daemon 追加）",
  "distill.builtin": "查看内置提示词",
  "distill.save": "保存",
...
const en: Record<string, string> = {
  ...
  "settings.subtitle": "platform behavior — distillation policy and preferences",
  "nav.inbox": "Inbox",
  ...
  "distill.prompt": "Custom extraction prompt",
  "distill.promptPh": "Empty = the built-in prompt (full replacement; the session transcript is still appended)",
  "distill.builtin": "View the built-in prompt",
  "distill.save": "Save",
