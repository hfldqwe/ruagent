...
export const zh: Record<string, string> = {
  ...
  "board.board": "看板",
  "board.err": "无法加载任务列表",
  "board.err.hint": "读不到任务：daemon 不可达，或者它返回的响应不符合契约。这不等于「还没有任务」。",
...
export const en: Record<string, string> = {
  ...
  "board.err.hint": "Cannot read tasks: the daemon is unreachable, or the response it returned does not match the contract. That is not the same as “no tasks yet”.",
